...
// // Remove js-cookie if you aren't using it for other things
...
//   useEffect(() => {
//     // USE localStorage TO MATCH YOUR BROWSE.TSX
...
//       // Handle the 403 Forbidden / 401 Unauthorized (Expired Token)
...
//     localStorage.removeItem("user"); // Clear user if stored
//     setIsLoggedIn(false);
//     setIsOpen(false);
//     setUnreadCount(0);
//     navigate("/login");
          ...
          <div className="flex items-center gap-1 md:gap-2 ml-2 md:border-l md:pl-4 border-gray-200">
            {isLoggedIn && (
              <>
                ...
                >
                  <Bell size={22} />
                  {/* Notification badge removed to stop API errors */}
                </Link>
